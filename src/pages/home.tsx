      ...
      <BackgroundPattern url={BackgroundPatternUrl}>
        <div className="max-w-6xl mx-auto px-4 py-8 relative z-10">
          ...
          <section className="grid md:grid-cols-2 gap-4">
            {weddingDetails.events.map((details) => <PlaceCard key={details.cardTitle} details={details} />)}

            <Card title="Confirme sua presença" backgroundImageHref={Rings}>
              <div className="flex-1 flex flex-col justify-between gap-2">
                <p className="text-gray-200">
                  Sua presença é muito importante para nós! Por favor, confirme até 01 de Novembro
                ...
                <Button
                  ...
                  className="w-full"
                  onClick={() => window.open(weddingDetails.whatsapp.groupLink, '_blank')}
                />
              </div>
            </Card>
            ...
            <Card title="Presente" backgroundImageHref={GiftBox}>
              <div className="flex-1 flex flex-col justify-between gap-2">
                <p className="text-gray-200">
                  Sua presença é o nosso maior presente! Mas se desejar nos ajudar com nossa lua de mel,
                  ficaremos muito gratos. Qualquer contribuição é opcional e bem-vinda.
                </p>
