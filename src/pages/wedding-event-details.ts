...
const weddingCeremonyDetails = {
	...
	venue: {
		...
		address:
			"Comunidade São Luís Gonzaga, R. João Franzner, 230 - São Luís, Jaraguá do Sul - SC, 89253-640",
...
const weddingReceptionDetails = {
	...
	venue: {
		...
		address:
			"Sociedade Desportos Acaraí, R. João Manoel Lopes Braga, 315 - Jaraguá Esquerdo, Jaraguá do Sul - SC, 89253-200",
...
export const weddingDetails = {
	whatsapp: weddingWhatsAppDetails,
	events: [weddingCeremonyDetails, weddingReceptionDetails],
	payment: weddingPaymentDetails,
};
